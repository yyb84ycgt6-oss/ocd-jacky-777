...
const ROOMS: RoomDef[] = [
  ...
  { id: 'creatures', label: 'Creature Lab', icon: <Bug size={22} />, color: 'hsl(90, 60%, 50%)', description: 'Breed, mutate, legacy NFTs', status: 'coming_soon', category: 'create' },
  ...
  { id: 'music', label: 'Music Lab', icon: <Music size={22} />, color: 'hsl(320, 70%, 55%)', description: 'AI music creation', status: 'coming_soon', category: 'create' },
