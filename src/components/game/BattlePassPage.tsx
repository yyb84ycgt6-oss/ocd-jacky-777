...
const BATTLE_PASS_REWARDS: BattlePassReward[] = [
  ...
  { tier: 20, name: '12 💎 Diamonds', icon: '💎', description: 'Diamond treasure', type: 'free', category: 'currency', rarity: 'epic',
  ...
  { tier: 24, name: 'Mythic Pack', icon: '💎', description: 'Mythic card pack', type: 'free', category: 'consumable', rarity: 'epic' },
  { tier: 25, name: '15 💎 Diamonds', icon: '💎', description: 'Diamond vault', type: 'free', category: 'currency', rarity: 'epic',
  ...
  { tier: 28, name: 'Shield (12h)', icon: '🛡️', description: 'Day shield', type: 'free', category: 'consumable', rarity: 'epic',
    effect: { type: 'shield', value: 1, duration: 43200 } },
  { tier: 29, name: '20000 Gold', icon: '🪙', description: 'Emperor gold', type: 'free', category: 'currency', rarity: 'epic' },
  ...
  { tier: 5, name: '5 💎 Diamonds', icon: '👑', description: 'Premium diamond bonus', type: 'premium', category: 'currency', rarity: 'rare',
    effect: { type: 'instant_resource', value: 5, target: 'diamonds' } },
  { tier: 10, name: '10 💎 Diamonds', icon: '👑', description: 'Premium diamond chest', type: 'premium', category: 'currency', rarity: 'epic',
    effect: { type: 'instant_resource', value: 10, target: 'diamonds' } },
  { tier: 15, name: '15 💎 Diamonds', icon: '👑', description: 'Premium diamond hoard', type: 'premium', category: 'currency', rarity: 'epic',
    effect: { type: 'instant_resource', value: 15, target: 'diamonds' } },
